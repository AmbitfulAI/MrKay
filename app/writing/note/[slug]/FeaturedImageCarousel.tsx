...
export function FeaturedImageCarousel({ images }: { images: string[] }) {
  ...
  return (
    <div style={{ position: "relative", width: "100%", aspectRatio: "21/8", overflow: "hidden", background: "var(--surface)" }}>
      <Image
        key={index}
        src={images[index]}
        alt=""
        ...
        {images.map((_, i) => (
          <button
            ...
            style={{
              ...
              height: "6px",
              background: i === index ? "var(--gold)" : "color-mix(in srgb, var(--text) 40%, transparent)",
              border: "none",
              cursor: "pointer",
              padding: 0,
