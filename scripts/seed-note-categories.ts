...
const VISUAL_DIARY_CATEGORIES = [
  { title: "Portrait",     slug: "portrait",     type: "visual-diary", order: 1 },
  { title: "Professional", slug: "professional", type: "visual-diary", order: 2 },
  { title: "Travel",       slug: "travel",       type: "visual-diary", order: 3 },
  { title: "Behind the Scenes", slug: "behind-the-scenes", type: "visual-diary", order: 4 },
];
...
async function run() {
  ...
  VISUAL_DIARY_CATEGORIES.forEach((c) => console.log(`  · ${c.title}`));
