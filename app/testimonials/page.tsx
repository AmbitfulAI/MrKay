...
export const metadata = {
  ...
  description: "Real work. Real results. What clients have said about the work, and a small set of recent engagements — named where permission exists, anonymised where it doesn't.",
};
...
const testimonials = [
  ...
  {
    quote: "We were trying to define what my organisation is aiming to achieve. I needed help understanding structure and how to build out ideas that are marketable. Together we created a revised vision, mission, goals, and business model for the organisation I am building.",
    name: "Founder",
  ...
  },
  {
    ...
    context: "International Education Organisation · Organisational Systems & Execution",
  },
  {
...
const caseStudies = [
  {
    ...
    outcome: "Fragmented assessment process turned into a governed, decision-grade operating system.",
  ...
  },
  {
    ...
    descriptor: "Senior media executive · Foundational brand and strategy architecture",
    outcome: "Personal positioning and initiative strategy established as the foundation for everything downstream.",
  ...
  },
  {
    ...
    title: "The Build",
    descriptor: "Talent Rendezvous · Lagos · Founder strategy and ongoing advisory",
    outcome: "Founder strategy sharpened. Brand identity introduced. The work continues.",
          ...
          <div className="flex flex-col gap-[2px] bg-surface-2">
            {caseStudies.map((s) => (
              <article key={s.code} className="bg-bg" style={{ padding: "64px 56px" }}>
                ...
                <p className="text-dim font-light" style={{ fontSize: "0.75rem", letterSpacing: "0.08em", marginBottom: "32px" }}>{s.descriptor}</p>
