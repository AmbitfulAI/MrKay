...
const areas = [
  ...
  { title: "CEO & Executive Succession", desc: "Succession at the top is among the most consequential and most poorly managed processes in corporate life. We advise boards on succession planning with a rigour that internal HR processes rarely achieve." },
  ...
  { title: "Crisis Navigation",          desc: "When an organisation faces a material crisis — reputational, regulatory, financial, or human — the quality of board oversight in those first weeks is decisive. We provide direct, calm counsel to boards and chairs navigating sudden complexity." },
];

export default function BoardAdvisory() {
  return (
    <>
      <PageHero eyebrow="Services — Board Advisory" title="Independent Counsel for Boards." subtitle="Governance, succession, and strategic transformation — viewed from the outside, with the experience of someone who has sat on both sides of the table." />
        ...
        <div className="container">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-20 items-start">
            ...
            <div>
              ...
              <p className="text-muted font-light" style={{fontSize:"0.95rem",lineHeight:1.9}}>We provide independent advisory to boards, chairs, and nomination committees — bringing an outside perspective informed by experience across listed, private, government, and not-for-profit entities.</p>
            </div>
          </div>
        </div>
      </section>
