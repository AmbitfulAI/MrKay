...
const pillars = [
  { title: "Behavioural Mastery",       desc: "Leadership behaviour is the aggregate of thousands of micro-decisions made daily — how you enter a room, how you listen, when you speak and when you do not. We work on the specifics, not the generalities." },
  ...
  { title: "Executive Presence",        desc: "Presence is not charisma — it is the consistent projection of authority, conviction, and calm across every context. We develop this with precision, across the full range of executive environments." },
  { title: "Organisational Leadership", desc: "Individual capability is necessary but insufficient. We develop leaders who can build cultures, align organisations, and create conditions in which talent grows without depending on the leader's constant presence." },
];

export default function LeadershipDevelopment() {
  return (
    <>
      <PageHero eyebrow="Services — Leadership Development" title="Leaders Are Made, Not Born." subtitle="Developing the behaviours, mindsets, and presence of leaders at every level. Rigorous, individualised, and built around what your organisation actually needs." />
        ...
        <div className="container">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-20 items-start">
            ...
            <div>
              ...
              <p className="text-muted font-light" style={{fontSize:"0.95rem",lineHeight:1.9}}>We work across extended, structured engagements — with individuals and with teams — to build leadership capability that is observable, durable, and directly linked to organisational outcomes.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-surface border-t border-surface-2 s-pad">
        <div className="container">
          <span className="eyebrow block mb-4">Our Focus Areas</span>
      ...
      <section className="bg-surface s-pad-sm">
        <div className="container">
          ...
          <div className="flex flex-wrap gap-4">
            {[{label:"Executive Strategy",href:"/executive-strategy"},{label:"Board Advisory",href:"/board-advisory"}].map((s)=>(
