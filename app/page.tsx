...
import heroImage from "@/assets/KK_Upperbody_BW.jpg";
    ...
    <>
      ...
      <section className="bg-bg relative overflow-hidden flex flex-col justify-center min-h-svh pt-20 pb-16 md:pt-24 md:pb-20">
        <div
          ...
          style={{
            backgroundImage:
              "linear-gradient(var(--gold-glow) 1px, transparent 1px), linear-gradient(90deg, var(--gold-glow) 1px, transparent 1px)",
        ...
        <div
          ...
          style={{
            ...
            height: "700px",
            background:
              "radial-gradient(circle, color-mix(in srgb, var(--gold) 8%, transparent) 0%, transparent 70%)",
          }}
        />

        <div className="container relative grid grid-cols-1 md:grid-cols-2 items-center gap-12">
          <div>
            <span className="eyebrow anim-fade-up block mb-8 md:mb-10">
              Executive Consulting
            </span>
            <h1
              className="display text-text anim-fade-up anim-delay-1 mb-8 md:mb-10"
              style={{
          ...
          <div
            className="relative hidden md:block w-full ml-auto anim-fade-up anim-delay-2"
          ...
          >
            <Image
              ...
              sizes="(max-width: 1160px) 50vw, 480px"
            />
            <div
