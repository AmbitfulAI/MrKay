...
const faqs = [
  {
    q: "Am I the kind of person you work with?",
    a: "If you're a professional or executive navigating a career inflection point, a founder building or restructuring a business, or a leader of a scaling organisation that needs operating systems, governance rhythms, manager development, or Fractional COO support — yes, very likely. Not every enquiry becomes an engagement; the first conversation is how we both find out whether there's a meaningful fit.",
  },
  {
    q: "What happens after I reach out?",
    a: "We have a direct, complimentary conversation. From there, the engagement is designed around your specific need — a structured programme, an advisory arrangement, a workshop, or a longer operating partnership.",
  },
  {
    q: "Will this stay confidential?",
    a: "Completely. Client relationships are never disclosed, and nothing you share is used in marketing or content without your explicit permission. Discretion is a founding principle of this practice.",
  },
  {
    q: "Does location matter?",
    a: "No. I'm based in the Netherlands and work with clients across Africa, Europe, and North America — engagements have spanned Nigeria, Kenya, the US, the UK, and beyond. Work runs remotely by default, and in person where proximity adds genuine value.",
  },
  {
    q: "What if I'm not sure which path fits me?",
    a: "That's normal — and it's literally the work. Reach out anyway and describe where you are. Helping you name the real problem is how every good engagement begins.",
  },
];
